...
namespace Lowscope.Saving.Components
{
    ...
    public class Saveable : MonoBehaviour
    {
        ...
        public void OnSaveRequest(SaveGame saveGame)
        {
            ...
            bool isDontDestroyOnLoad = gameObject.scene.buildIndex == -1;

            int componentCount = saveableComponentIDs.Count;
            string scene = !isDontDestroyOnLoad? SaveMaster.GetSceneName(gameObject.scene.GetHashCode()) : "DontDestroyOnLoad";
